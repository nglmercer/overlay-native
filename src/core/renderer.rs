...
use super::config::{AnimationSettings, CoreConfig, DisplaySettings, MessageFilter, ProcessingSettings, WindowSettings};
use super::message::{ChatMessageElement, Emote, GiftElement, OverlayElement};
...
impl CoreRenderer {
    ...
    pub async fn queue_element(&self, element: OverlayElement) -> Result<String, RenderError> {
        ...
        if !should_display {
            ...
            return Err(RenderError::InvalidMessage("Message filtered out".to_string()));
        }
    ...
    pub async fn process_chat_message(&self, message: ChatMessageElement) -> Result<String, RenderError> {
        self.queue_element(OverlayElement::ChatMessage(message)).await
    }
    ...
    pub async fn process_emote(&self, emote: super::message::EmoteElement) -> Result<String, RenderError> {
